      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="rounded-xl border" style={{ backgroundColor: 'rgb(255,255,255)', borderColor: 'rgb(229,231,235)' }}>
          ...
          <div className="p-5 space-y-3">
            ...
            <Link to="/admin/onboarding-preview" className="flex items-center gap-3 p-3 rounded-lg hover:bg-[rgb(249,250,251)] transition-colors">
              <div className="w-9 h-9 rounded-lg flex items-center justify-center" style={{ backgroundColor: 'rgb(255,243,235)' }}>
                <svg className="w-4 h-4" style={{ color: 'rgb(221,110,66)' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                <p className="text-sm font-medium" style={{ color: 'rgb(17,24,39)' }}>Preview Onboarding</p>
                <p className="text-xs" style={{ color: 'rgb(156,163,175)' }}>Walk through the onboarding wizard</p>
              </div>
            </Link>
          </div>
        </div>
