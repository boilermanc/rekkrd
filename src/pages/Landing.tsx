...
const Landing: React.FC<LandingProps> = ({ onEnterApp, scrollToPricing }) => {
  ...
  const handleCheckout = async (tier: 'curator' | 'enthusiast', skipTrial = false) => {
    if (!user) {
      openAuthPanel('signup');
      return;
    }
  ...
  return (
    <div className="landing-page">
      ...
      <section className="hero">
        ...
        <div className="container">
          <div>
            ...
            <h1 dangerouslySetInnerHTML={{ __html: sanitizeCmsHtml(content.hero.heading) }} />
        ...
        <div className="container">
          ...
          <div className="pricing-grid">
            ...
            <div className="price-card">
              ...
              <button className="price-btn outline" onClick={() => handleCheckout('enthusiast')}>Start Free Trial</button>
              <button className="skip-trial-link" onClick={() => handleCheckout('enthusiast', true)}>Or buy now &mdash; no trial</button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="final-cta" id="cta">
        <div className="container">
          <h2 dangerouslySetInnerHTML={{ __html: sanitizeCmsHtml(content.final_cta.heading) }} />
