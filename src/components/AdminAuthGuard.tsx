      ...
      <div className="admin-root flex items-center justify-center min-h-screen" style={{ background: '#f9fafb' }}>
        <div className="w-full max-w-sm px-6">
          ...
          <div className="text-center mt-6">
            <a href="/" className="text-sm hover:underline" style={{ color: 'rgb(99,102,241)' }}>Back to Rekk<span className="text-[#c45a30]">r</span>d</a>
          </div>
        </div>
      </div>
    );
      ...
      <div className="admin-root flex items-center justify-center min-h-screen">
        <div className="text-center max-w-sm px-6">
          ...
          >
            ...
            Back to Rekk<span className="text-[#c45a30]">r</span>d
          </a>
        </div>
      </div>
    );
