      ...
      {currentView !== 'landing' && currentView !== 'stakkd' && currentView !== 'profile' && currentView !== 'price-alerts' && <div className="flex-1 max-w-xl flex items-center gap-2">
        ...
        <div className="flex-1 relative">
          <input
            ...
            className={`w-full bg-th-surface/[0.04] border border-th-surface/[0.10] rounded-full pl-10 ${searchQuery ? 'pr-9' : 'pr-4'} py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#dd6e42]/50 transition-all placeholder:text-th-text3/60`}
          />
