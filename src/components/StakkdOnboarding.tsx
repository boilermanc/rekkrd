        ...
        <div className="glass-morphism rounded-3xl border border-th-surface/[0.10] p-8 md:p-10">
          ...
          {step === 0 && (
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-th-text mb-3">
                Welcome to <span className="text-[#dd6e42]">Stakkd</span>
              </h2>
          ...
          {step === 1 && (
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-th-text mb-3">
                Add Your <span className="text-[#dd6e42]">Gear</span>
              </h2>
          ...
          {step === 2 && (
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-th-text mb-3">
                Signal <span className="text-[#dd6e42]">Chain</span>
              </h2>
              <p className="text-th-text3/70 text-sm leading-relaxed max-w-sm mb-6">
                  ...
                  <React.Fragment key={item.label}>
                    <div className="flex flex-col items-center gap-1">
                      <div className="w-10 h-10 rounded-lg bg-th-surface/[0.06] border border-th-surface/[0.10] flex items-center justify-center">
                        <svg className="w-5 h-5 text-[#dd6e42]/70" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1} strokeLinecap="round" strokeLinejoin="round">
                          {item.icon}
                        </svg>
                      </div>
          ...
          {step === 3 && (
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-th-text mb-3">
                Powerful <span className="text-[#dd6e42]">Features</span>
              </h2>
              <p className="text-th-text3/70 text-sm leading-relaxed max-w-sm mb-6">
