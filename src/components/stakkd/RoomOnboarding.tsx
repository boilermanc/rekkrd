        ...
        <div className="glass-morphism rounded-3xl border border-th-surface/[0.10] p-8 md:p-10">
          ...
          {step === 0 && (
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-th-text mb-3">
                Welcome to <span className="text-[#dd6e42]">Room Planner</span>
              </h2>
          ...
          {step === 1 && (
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-th-text mb-3">
                Define Your <span className="text-[#dd6e42]">Room</span>
              </h2>
          ...
          {step === 2 && (
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-th-text mb-3">
                Add Wall <span className="text-[#dd6e42]">Features</span>
              </h2>
              <p className="text-th-text3/70 text-sm leading-relaxed max-w-sm mb-6">
          ...
          {step === 3 && (
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-th-text mb-3">
                Generate AI <span className="text-[#dd6e42]">Layout</span>
              </h2>
              <p className="text-th-text3/70 text-sm leading-relaxed max-w-sm mb-6">
