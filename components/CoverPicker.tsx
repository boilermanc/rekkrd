        ...
        <div className="flex-1 overflow-y-auto p-6 custom-scrollbar">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 gap-4">
              <svg className="w-12 h-12 text-th-text3/30" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
                  ...
                  <button
                    ...
                    className={`group relative rounded-xl overflow-hidden border-2 transition-all duration-200 hover:scale-[1.03] ${
                      isActive
                        ...
                        : 'border-th-surface/[0.06] hover:border-th-surface/[0.15]'
                    }`}
                  >
                    <div className="aspect-square bg-th-surface/[0.04]">
                      <img
                    ...
                    {/* Label */}
                    {cover.label && (
                      <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-th-bg/80 to-transparent p-2 pt-6">
                        <p className="text-th-text/80 text-[9px] truncate">{cover.label}</p>
                      </div>
                    )}
                  </button>
                );
